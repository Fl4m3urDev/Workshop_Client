export const configuration = () => ({
  ...
  openAPITitle: 'workshop_client nestjs example', // title of the open api docs
  openAPIDescription: 'nestjs component for workshop_client', // description of the open api docs
  ...
  mailerDefaultFrom: '"workshop_client" <workshop_client@example.com>', // Default from for mails
